export default function Welcome() {
    return (
        <div className="w-[500px] bg-[#fafaf0] text-sm text-gray-800 dark:text-gray-100 space-y-4 mx-auto">
            <div className="break-words p-2 justify-center ">
            <h1 className="text-xl font-bold pb-4">Welcome to Hacker News</h1>
            <hr />
            <p className="p-1">
